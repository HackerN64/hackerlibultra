...
enum crashPages { PAGE_SIMPLE, PAGE_CONTEXT, PAGE_STACKTRACE, PAGE_DISASM, PAGE_ASSERTS, PAGE_COUNT };

static char* crashPageNames[PAGE_COUNT + NUM_USER_PAGES] = {
    [PAGE_SIMPLE] = "(Overview)",    [PAGE_CONTEXT] = "(Context)", [PAGE_STACKTRACE] = "(Stack Trace)",
    [PAGE_DISASM] = "(Disassembly)", [PAGE_ASSERTS] = "(Assert)",
};
...
static u32 sCrashScreenFont[GLYPH_HEIGHT * FONT_ROWS * 2 + 1] = {
    0x00000000, 0x00000000, 0x00000000, 0x40000000, 0x007070f0, 0x20000000, 0x00888888, 0x00000000, 0x0098b888,
    0x00f00000, 0x00a8a8f0, 0x00880000, 0x00c8b880, 0x00880000, 0x00888080, 0x00880000, 0x00707880, 0x00f00000,
    0x00000000, 0x00800000, 0x00000000, 0x00800000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x20202070, 0x00000000, 0x20e05088, 0x00000000, 0x20205088, 0x78780000, 0x20208888, 0x88880000,
    0x2020f888, 0x88880000, 0x002088a8, 0x98880000, 0x20f88870, 0x68780000, 0x00000008, 0x00080000, 0x00000000,
    0x00080000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x50000000, 0x00000000, 0x5070f0f0, 0x80000000,
    0x50888888, 0x80000000, 0x00088888, 0xf0b00000, 0x0010f0f0, 0x88c80000, 0x00208888, 0x88800000, 0x00408888,
    0x88800000, 0x00f8f088, 0xf0800000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x50707070, 0x00000000, 0xf8888888, 0x00000000, 0x50088080,
    0x70780000, 0xf8308070, 0x88800000, 0x50088008, 0x80700000, 0x00888888, 0x80080000, 0x00707070, 0x78f00000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x20000000,
    0x00000000, 0x7010f0f8, 0x08200000, 0xa8308820, 0x08200000, 0xa0508820, 0x78700000, 0x70908820, 0x88200000,
    0x28f88820, 0x88200000, 0xa8108820, 0x88200000, 0x7038f020, 0x78180000, 0x20000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x48f8f888, 0x00000000,
    0xa8808088, 0x00000000, 0xb0f08088, 0x70880000, 0x7008f088, 0x88880000, 0x68088088, 0xf8880000, 0xa8888088,
    0x80980000, 0x9070f870, 0x78680000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x6070f888, 0x18000000, 0x90808088, 0x20000000, 0xa0f08088,
    0x70880000, 0x4088f050, 0x20880000, 0xa8888050, 0x20500000, 0x90888020, 0x20500000, 0x68708020, 0x20200000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x20000000,
    0x00000000, 0x20f87088, 0x00000000, 0x20088888, 0x00000000, 0x00088088, 0x78a80000, 0x001098a8, 0x88a80000,
    0x002088a8, 0x88a80000, 0x002088d8, 0x88a80000, 0x00207088, 0x78500000, 0x00000000, 0x08000000, 0x00000000,
    0x70000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x10000000, 0x00000000, 0x20708888, 0x80000000,
    0x40888888, 0x80000000, 0x40888850, 0xf0880000, 0x4070f820, 0x88500000, 0x40888850, 0x88200000, 0x40888888,
    0x88500000, 0x20708888, 0x88880000, 0x10000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x40000000, 0x00000000, 0x2070f888, 0x20000000, 0x10882088, 0x00000000, 0x10882088,
    0x60880000, 0x10882050, 0x20880000, 0x10782020, 0x20880000, 0x10082020, 0x20880000, 0x2070f820, 0x70780000,
    0x40000000, 0x00080000, 0x00000000, 0x00700000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x200008f8, 0x20000000, 0xa8600808, 0x00000000, 0x70600810, 0x60f80000, 0x70000820, 0x20100000,
    0xa8608840, 0x20200000, 0x20608880, 0x20400000, 0x000070f8, 0x20f80000, 0x00000000, 0x20000000, 0x00000000,
    0xc0000000, 0x00000000, 0x00000000, 0x00000000, 0x00100000, 0x00000030, 0x00200000, 0x00008820, 0x80200000,
    0x20609020, 0x80200000, 0x2060a020, 0x90200000, 0xf800c020, 0xa0400000, 0x2060a020, 0xe0200000, 0x20609020,
    0x90200000, 0x00208820, 0x88200000, 0x00400030, 0x00200000, 0x00000000, 0x00100000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000080, 0x00200000, 0x00088040, 0x60200000, 0x00108040, 0x20200000, 0x00208020,
    0x20200000, 0x00408020, 0x20200000, 0x60208010, 0x20200000, 0x60108010, 0x20200000, 0x2008f808, 0x70200000,
    0x40000008, 0x00200000, 0x00000004, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00400000, 0x00000060,
    0x00200000, 0x00008820, 0x00200000, 0x0000d820, 0x00200000, 0x00f8a820, 0xf0200000, 0x7000a820, 0xa8100000,
    0x00f88820, 0xa8200000, 0x00008820, 0xa8200000, 0x00008820, 0xa8200000, 0x00000060, 0x00200000, 0x00000000,
    0x00400000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00408820, 0x00000000,
    0x0020c850, 0x00000000, 0x0010a888, 0xb0680000, 0x00089800, 0xc8b00000, 0x00108800, 0x88000000, 0x60208800,
    0x88000000, 0x60408800, 0x88000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x04000000, 0x00000000, 0x08707000, 0x00000000, 0x08888800, 0x00000000, 0x10088800,
    0x70000000, 0x10108800, 0x88000000, 0x20208800, 0x88000000, 0x20008800, 0x88000000, 0x40207000, 0x70000000,
    0x40000000, 0x00000000, 0x800000fc, 0x00000000, 0x00000000, 0x00000000
};
...
void draw_stacktrace(OSThread* thread, s32 cause) {
    ...
    for (int i = 0; i < STACK_LINE_COUNT; i++) {
        ...
        crash_screen_print(120, 55 + (i * 10), "%3d: %08X", i + STACK_LINE_COUNT,
                           *((u32*)(sp + ((i + STACK_LINE_COUNT) * 4))));
    }
...
void draw_crash_screen(OSThread* thread) {
    ...
    if (crashPage == 255) {
        ...
        if (crashPage == PAGE_ASSERTS && tc->cause != EXC_SYSCALL)
            crashPage--;
    }
    if (updateBuffer) {
        crash_screen_draw_rect(0, 0, 320, 20);
        crash_screen_print(LEFT_MARGIN, 5, "Page:%02d %-22s L/Z: Left   R: Right", crashPage,
                           crashPageNames[crashPage]);
        switch (crashPage) {
            case PAGE_SIMPLE:
                draw_crash_overview(thread, cause);
                break;
            case PAGE_CONTEXT:
...
void osCreateFaultHandler(void) {
    ...
    osCreateThread(&__osCurrentFaultContext.thread, FAULT_THREAD, osFaultMain, NULL,
                   (u8*)__osCurrentFaultContext.stack + sizeof(__osCurrentFaultContext.stack), OS_PRIORITY_APPMAX);
