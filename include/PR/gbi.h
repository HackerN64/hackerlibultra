...
#define RM_AA_ZB_TEX_INTER(clk)                                                                        \
    AA_EN | Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | CVG_X_ALPHA | ALPHA_CVG_SEL | ZMODE_INTER          \
...
#define gdSPDefLights3(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, \
                       z3)                                                                             \
    {                                                                                                  \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                           \
...
#define gdSPDefLights4(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, \
                       z3, r4, g4, b4, x4, y4, z4)                                                     \
    {                                                                                                  \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                           \
...
#define gdSPDefLights5(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, \
                       z3, r4, g4, b4, x4, y4, z4, r5, g5, b5, x5, y5, z5)                             \
    {                                                                                                  \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                           \
                { { { r2, g2, b2 }, 0, { r2, g2, b2 }, 0, { x2, y2, z2 }, 0 } },                       \
...
#define gdSPDefLights6(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, \
                       z3, r4, g4, b4, x4, y4, z4, r5, g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6)     \
    {                                                                                                  \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                           \
                { { { r2, g2, b2 }, 0, { r2, g2, b2 }, 0, { x2, y2, z2 }, 0 } },                       \
...
#define gdSPDefLights7(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, \
                       z3, r4, g4, b4, x4, y4, z4, r5, g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6, r7, \
                       g7, b7, x7, y7, z7)                                                             \
    {                                                                                                  \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                           \
...
#define gsDma2p(c, adrs, len, idx, ofs)                                                                \
    {                                                                                                  \
        {                                                                                              \
            (_SHIFTL((c), 24, 8) | _SHIFTL(((len) - 1) / 8, 19, 5) | _SHIFTL((ofs) / 8, 8, 8)          \
             | _SHIFTL((idx), 0, 8)),                                                                  \
                (unsigned int) (adrs)                                                                  \
        }                                                                                              \
    }
...
#else
#define __gsSP1Triangle_w1f(v0, v1, v2, flag)                                                          \
    (_SHIFTL((flag), 24, 8) | _SHIFTL((v0) * 10, 16, 8) | _SHIFTL((v1) * 10, 8, 8)                     \
     | _SHIFTL((v2) * 10, 0, 8))
#define __gsSPLine3D_w1f(v0, v1, wd, flag)                                                             \
    (_SHIFTL((flag), 24, 8) | _SHIFTL((v0) * 10, 16, 8) | _SHIFTL((v1) * 10, 8, 8)                     \
     | _SHIFTL((wd), 0, 8))
...
#define gSPModifyVertex(pkt, vtx, where, val)                                                          \
    {                                                                                                  \
        Gfx *_g = (Gfx *) (pkt);                                                                       \
        _g->words.w0 =                                                                                 \
            (_SHIFTL(G_MODIFYVTX, 24, 8) | _SHIFTL((where), 16, 8) | _SHIFTL((vtx) * 2, 0, 16));       \
...
#define gsSPLightColor(n, col)                                                                         \
    gsMoveWd(G_MW_LIGHTCOL, G_MWO_a##n, col), gsMoveWd(G_MW_LIGHTCOL, G_MWO_b##n, col)
...
#define gsSPSetLights2(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_2), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.a, 3)
...
#define gsSPSetLights3(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_3), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.l[2], 3), gsSPLight(&name.a, 4)
...
#define gsSPSetLights4(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_4), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.l[2], 3), gsSPLight(&name.l[3], 4), gsSPLight(&name.a, 5)
...
#define gsSPSetLights5(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_5), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.l[2], 3), gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                  \
        gsSPLight(&name.a, 6)
...
#define gsSPSetLights6(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_6), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.l[2], 3), gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                  \
...
#define gsSPSetLights7(name)                                                                           \
    gsSPNumLights(NUMLIGHTS_7), gsSPLight(&name.l[0], 1), gsSPLight(&name.l[1], 2),                    \
        gsSPLight(&name.l[2], 3), gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                  \
        gsSPLight(&name.l[5], 6), gsSPLight(&name.l[6], 7), gsSPLight(&name.a, 8)
...
#define gsSPTextureL(s, t, level, xparam, tile, on)                                                    \
    {                                                                                                  \
        {                                                                                              \
            (_SHIFTL(G_TEXTURE, 24, 8) | _SHIFTL((xparam), 16, 8) | _SHIFTL((level), 11, 3)            \
             | _SHIFTL((tile), 8, 3) | _SHIFTL((on), 1, 7)),                                           \
                (_SHIFTL((s), 16, 16) | _SHIFTL((t), 0, 16))                                           \
        }                                                                                              \
    }
...
#define gSetImage(pkt, cmd, fmt, siz, width, i)                                                        \
    {                                                                                                  \
        Gfx *_g = (Gfx *) (pkt);                                                                       \
                                                                                                       \
        _g->words.w0 = _SHIFTL(cmd, 24, 8) | _SHIFTL(fmt, 21, 3) | _SHIFTL(siz, 19, 2)                 \
...
#define gDPLoadBlock(pkt, tile, uls, ult, lrs, dxt)                                                    \
    {                                                                                                  \
        ...
        _g->words.w1 = (_SHIFTL(tile, 24, 3) | _SHIFTL((MIN(lrs, G_TX_LDBLK_MAX_TXL)), 12, 12)         \
                        | _SHIFTL(dxt, 0, 12));                                                        \
    }
...
#define gDPLoadTextureBlock(pkt, timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt, shifts,   \
                            shiftt)                                                                    \
    {                                                                                                  \
        ...
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, siz, (((width) * siz##_LINE_BYTES) + 7) >> 3, 0, G_TX_RENDERTILE, pal,    \
                   cmt, maskt, shiftt, cms, masks, shifts);                                            \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,              \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }

#define gDPLoadTextureBlockYuv(pkt, timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt,        \
                               shifts, shiftt)                                                         \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, \
        ...
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1, \
                     CALC_DXT(width, siz##_BYTES));                                                    \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, siz, (((width) * 1) + 7) >> 3, 0, G_TX_RENDERTILE, pal, cmt, maskt,       \
...
#define gDPLoadTextureBlockS(pkt, timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt, shifts,  \
                             shiftt)                                                                   \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, \
 ...
 *  The S at the end means odd lines are already word Swapped
 */
#define gDPLoadMultiBlockS(pkt, timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt, masks,      \
                           maskt, shifts, shiftt)                                                      \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms,     \
                   masks, shifts);                                                                     \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1, \
                     0);                                                                               \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, siz, (((width) * siz##_LINE_BYTES) + 7) >> 3, tmem, rtile, pal, cmt,      \
                   maskt, shiftt, cms, masks, shifts);                                                 \
        gDPSetTileSize(pkt, rtile, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                        \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }

#define gDPLoadTextureBlockYuvS(pkt, timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt,       \
                                shifts, shiftt)                                                        \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, \
 ...
 */
#define _gDPLoadTextureBlock(pkt, timg, tmem, fmt, siz, width, height, pal, cms, cmt, masks, maskt,    \
                             shifts, shiftt)                                                           \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms,     \
        ...
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1, \
                     CALC_DXT(width, siz##_BYTES));                                                    \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, siz, (((width) * siz##_LINE_BYTES) + 7) >> 3, tmem, G_TX_RENDERTILE, pal, \
                   cmt, maskt, shiftt, cms, masks, shifts);                                            \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,              \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }
 ...
 */
#define _gDPLoadTextureBlockTile(pkt, timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt,       \
 ...
 *  allows tmem address and render tile to be specified
 */
#define gDPLoadMultiBlock(pkt, timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt, masks,       \
                          maskt, shifts, shiftt)                                                       \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);                                       \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms,     \
...
#define gsDPLoadTextureBlock(timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt, shifts,       \
                             shiftt)                                                                   \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,     \
                    shifts),                                                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1,     \
                      CALC_DXT(width, siz##_BYTES)),                                                   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, siz, ((((width) * siz##_LINE_BYTES) + 7) >> 3), 0, G_TX_RENDERTILE, pal, cmt, \
                    maskt, shiftt, cms, masks, shifts),                                                \
...
#define gsDPLoadTextureBlockS(timg, fmt, siz, width, height, pal, cms, cmt, masks, maskt, shifts,      \
                              shiftt)                                                                  \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,     \
 ...
 */
#define _gsDPLoadTextureBlock(timg, tmem, fmt, siz, width, height, pal, cms, cmt, masks, maskt,        \
                              shifts, shiftt)                                                          \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
                    shifts),                                                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1,     \
                      CALC_DXT(width, siz##_BYTES)),                                                   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, siz, ((((width) * siz##_LINE_BYTES) + 7) >> 3), tmem, G_TX_RENDERTILE, pal,   \
                    cmt, maskt, shiftt, cms, masks, shifts),                                           \
        gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                  \
                        ((height) - 1) << G_TEXTURE_IMAGE_FRAC)
 ...
 */
#define _gsDPLoadTextureBlockTile(timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt, masks,    \
                                  maskt, shifts, shiftt)                                               \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
        ...
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1,     \
                      CALC_DXT(width, siz##_BYTES)),                                                   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, siz, ((((width) * siz##_LINE_BYTES) + 7) >> 3), tmem, rtile, pal, cmt, maskt, \
                    shiftt, cms, masks, shifts),                                                       \
 ...
 */
#define gsDPLoadMultiBlock(timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt, masks, maskt,    \
                           shifts, shiftt)                                                             \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
...
#define gsDPLoadMultiBlockS(timg, tmem, rtile, fmt, siz, width, height, pal, cms, cmt, masks, maskt,   \
                            shifts, shiftt)                                                            \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                                               \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
...
#define gDPLoadTextureBlock_4b(pkt, timg, fmt, width, height, pal, cms, cmt, masks, maskt, shifts,     \
                               shiftt)                                                                 \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                                           \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,     \
                   shifts);                                                                            \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1,                    \
                     CALC_DXT_4b(width));                                                              \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), 0, G_TX_RENDERTILE, pal, cmt,   \
                   maskt, shiftt, cms, masks, shifts);                                                 \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,              \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }
...
#define gDPLoadTextureBlock_4bS(pkt, timg, fmt, width, height, pal, cms, cmt, masks, maskt, shifts,    \
                                shiftt)                                                                \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                                           \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,     \
 ...
 */
#define gDPLoadMultiBlock_4b(pkt, timg, tmem, rtile, fmt, width, height, pal, cms, cmt, masks, maskt,  \
                             shifts, shiftt)                                                           \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                                           \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
                   shifts);                                                                            \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1,                    \
                     CALC_DXT_4b(width));                                                              \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), tmem, rtile, pal, cmt, maskt,   \
                   shiftt, cms, masks, shifts);                                                        \
        gDPSetTileSize(pkt, rtile, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                        \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }
 ...
 */
#define gDPLoadMultiBlock_4bS(pkt, timg, tmem, rtile, fmt, width, height, pal, cms, cmt, masks, maskt, \
                              shifts, shiftt)                                                          \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                                           \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
...
#define _gDPLoadTextureBlock_4b(pkt, timg, tmem, fmt, width, height, pal, cms, cmt, masks, maskt,      \
                                shifts, shiftt)                                                        \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                                           \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,  \
        ...
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1,                    \
                     CALC_DXT_4b(width));                                                              \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), tmem, G_TX_RENDERTILE, pal,     \
                   cmt, maskt, shiftt, cms, masks, shifts);                                            \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,              \
                       ((height) - 1) << G_TEXTURE_IMAGE_FRAC)                                         \
    }
...
#define gsDPLoadTextureBlock_4b(timg, fmt, width, height, pal, cms, cmt, masks, maskt, shifts, shiftt) \
    ...
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                                                   \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,         \
                    shifts),                                                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1, CALC_DXT_4b(width)),   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), 0, G_TX_RENDERTILE, pal, cmt,       \
                    maskt, shiftt, cms, masks, shifts),                                                \
        gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                  \
                        ((height) - 1) << G_TEXTURE_IMAGE_FRAC)

#define gsDPLoadTextureBlock_4bS(timg, fmt, width, height, pal, cms, cmt, masks, maskt, shifts,        \
                                 shiftt)                                                               \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                                                   \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,         \
                    shifts),                                                                           \
        gsDPLoadSync(), gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1, 0),    \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), 0, G_TX_RENDERTILE, pal, cmt,       \
                    maskt, shiftt, cms, masks, shifts),                                                \
        gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                  \
 ...
 */
#define gsDPLoadMultiBlock_4b(timg, tmem, rtile, fmt, width, height, pal, cms, cmt, masks, maskt,      \
                              shifts, shiftt)                                                          \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                                                   \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,      \
                    shifts),                                                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1, CALC_DXT_4b(width)),   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), tmem, rtile, pal, cmt, maskt,       \
                    shiftt, cms, masks, shifts),                                                       \
        gsDPSetTileSize(rtile, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                            \
                        ((height) - 1) << G_TEXTURE_IMAGE_FRAC)
 ...
 */
#define gsDPLoadMultiBlock_4bS(timg, tmem, rtile, fmt, width, height, pal, cms, cmt, masks, maskt,     \
                               shifts, shiftt)                                                         \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                                                   \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,      \
 ...
 *  Allows tmem address to be specified
 */
#define _gsDPLoadTextureBlock_4b(timg, tmem, fmt, width, height, pal, cms, cmt, masks, maskt, shifts,  \
                                 shiftt)                                                               \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                                                   \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,      \
        ...
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0, (((width) * (height) + 3) >> 2) - 1, CALC_DXT_4b(width)),   \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, ((((width) >> 1) + 7) >> 3), tmem, G_TX_RENDERTILE, pal, cmt,    \
                    maskt, shiftt, cms, masks, shifts),                                                \
        gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, ((width) - 1) << G_TEXTURE_IMAGE_FRAC,                  \
                        ((height) - 1) << G_TEXTURE_IMAGE_FRAC)
...
#define gDPLoadTextureTile(pkt, timg, fmt, siz, width, height, uls, ult, lrs, lrt, pal, cms, cmt,      \
                           masks, maskt, shifts, shiftt)                                               \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz, width, timg);                                                \
        gDPSetTile(pkt, fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3), 0,            \
...
#define gDPLoadTextureTile(pkt, timg, fmt, siz, width, height, uls, ult, lrs, lrt, pal, cms, cmt,      \
    ...
    {                                                                                                  \
        ...
        guDPLoadTextureTile(_loadtile_temp, timg, fmt, siz, width, height, uls, ult, lrs, lrt, pal,    \
 ...
 */
#define gDPLoadMultiTile(pkt, timg, tmem, rtile, fmt, siz, width, height, uls, ult, lrs, lrt, pal,     \
                         cms, cmt, masks, maskt, shifts, shiftt)                                       \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, siz, width, timg);                                                \
        gDPSetTile(pkt, fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3), tmem,         \
                   G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts);                          \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,  \
                    (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC);                     \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, siz, (((((lrs) - (uls) + 1) * siz##_LINE_BYTES) + 7) >> 3), tmem, rtile,  \
                   pal, cmt, maskt, shiftt, cms, masks, shifts);                                       \
        gDPSetTileSize(pkt, rtile, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,       \
                       (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC)                   \
    }

#define gsDPLoadTextureTile(timg, fmt, siz, width, height, uls, ult, lrs, lrt, pal, cms, cmt, masks,   \
                            maskt, shifts, shiftt)                                                     \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz, width, timg),                                                        \
        gsDPSetTile(fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3), 0, G_TX_LOADTILE, \
 ...
 *  Useful for loading multiple tiles.
 */
#define gsDPLoadMultiTile(timg, tmem, rtile, fmt, siz, width, height, uls, ult, lrs, lrt, pal, cms,    \
                          cmt, masks, maskt, shifts, shiftt)                                           \
                                                                                                       \
    gsDPSetTextureImage(fmt, siz, width, timg),                                                        \
        gsDPSetTile(fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3), tmem,             \
                    G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts),                         \
        gsDPLoadSync(),                                                                                \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,      \
                     (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC),                    \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, siz, (((((lrs) - (uls) + 1) * siz##_LINE_BYTES) + 7) >> 3), tmem, rtile, pal, \
                    cmt, maskt, shiftt, cms, masks, shifts),                                           \
        gsDPSetTileSize(rtile, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,           \
                        (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC)

#define gDPLoadTextureTile_4b(pkt, timg, fmt, width, height, uls, ult, lrs, lrt, pal, cms, cmt, masks, \
                              maskt, shifts, shiftt)                                                   \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_8b, ((width) >> 1), timg);                               \
        gDPSetTile(pkt, fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, G_TX_LOADTILE,   \
                   0, cmt, maskt, shiftt, cms, masks, shifts);                                         \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),                           \
                    (ult) << (G_TEXTURE_IMAGE_FRAC), (lrs) << (G_TEXTURE_IMAGE_FRAC - 1),              \
                    (lrt) << (G_TEXTURE_IMAGE_FRAC));                                                  \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, G_TX_RENDERTILE, \
                   pal, cmt, maskt, shiftt, cms, masks, shifts);                                       \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC,                            \
                       (ult) << G_TEXTURE_IMAGE_FRAC, (lrs) << G_TEXTURE_IMAGE_FRAC,                   \
                       (lrt) << G_TEXTURE_IMAGE_FRAC)                                                  \
 ...
 *  Useful for loading multiple tiles.
 */
#define gDPLoadMultiTile_4b(pkt, timg, tmem, rtile, fmt, width, height, uls, ult, lrs, lrt, pal, cms,  \
                            cmt, masks, maskt, shifts, shiftt)                                         \
    {                                                                                                  \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_8b, ((width) >> 1), timg);                               \
        gDPSetTile(pkt, fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem,               \
                   G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts);                          \
        gDPLoadSync(pkt);                                                                              \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),                           \
                    (ult) << (G_TEXTURE_IMAGE_FRAC), (lrs) << (G_TEXTURE_IMAGE_FRAC - 1),              \
                    (lrt) << (G_TEXTURE_IMAGE_FRAC));                                                  \
        gDPPipeSync(pkt);                                                                              \
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem, rtile, pal,   \
                   cmt, maskt, shiftt, cms, masks, shifts);                                            \
        gDPSetTileSize(pkt, rtile, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,       \
                       (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC)                   \
    }

#define gsDPLoadTextureTile_4b(timg, fmt, width, height, uls, ult, lrs, lrt, pal, cms, cmt, masks,     \
                               maskt, shifts, shiftt)                                                  \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),                                       \
        gsDPSetTile(fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, G_TX_LOADTILE, 0,    \
                    cmt, maskt, shiftt, cms, masks, shifts),                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),                               \
                     ...
                     (lrt) << (G_TEXTURE_IMAGE_FRAC)),                                                 \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, G_TX_RENDERTILE,     \
                    pal, cmt, maskt, shiftt, cms, masks, shifts),                                      \
        gsDPSetTileSize(G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC, \
                        (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC)
 ...
 *  Useful for loading multiple tiles.
 */
#define gsDPLoadMultiTile_4b(timg, tmem, rtile, fmt, width, height, uls, ult, lrs, lrt, pal, cms, cmt, \
                             masks, maskt, shifts, shiftt)                                             \
                                                                                                       \
    gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),                                       \
        gsDPSetTile(fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem, G_TX_LOADTILE, 0, \
                    cmt, maskt, shiftt, cms, masks, shifts),                                           \
        gsDPLoadSync(),                                                                                \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),                               \
                     (ult) << (G_TEXTURE_IMAGE_FRAC), (lrs) << (G_TEXTURE_IMAGE_FRAC - 1),             \
                     (lrt) << (G_TEXTURE_IMAGE_FRAC)),                                                 \
        gsDPPipeSync(),                                                                                \
        gsDPSetTile(fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem, rtile, pal, cmt,  \
                    maskt, shiftt, cms, masks, shifts),                                                \
        gsDPSetTileSize(rtile, (uls) << G_TEXTURE_IMAGE_FRAC, (ult) << G_TEXTURE_IMAGE_FRAC,           \
                        (lrs) << G_TEXTURE_IMAGE_FRAC, (lrt) << G_TEXTURE_IMAGE_FRAC)
...
#define gDPLoadTLUT_pal16(pkt, pal, dram)                                                              \
                                                                                                       \
    _gDPLoadTextureBlock(pkt, dram, (256 + (((pal) & 0xf) * 16)), G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 16, \
                         1, pal, 0, 0, 0, 0, 0, 0)
...
#define gsDPLoadTLUT_pal16(pal, dram)                                                                  \
                                                                                                       \
    _gsDPLoadTextureBlock(dram, (256 + (((pal) & 0xf) * 16)), G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 16, 1,  \
                          pal, 0, 0, 0, 0, 0, 0)
...
#define gDPLoadTLUT(pkt, count, tmemaddr, dram)                                                        \
                                                                                                       \
    _gDPLoadTextureBlock(pkt, dram, tmemaddr, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, count, 0, 0, 0, 0, 0, 0, \
                         0)
...
#define gDPSetScissorFrac(pkt, mode, ulx, uly, lrx, lry)                                               \
    {                                                                                                  \
        Gfx *_g = (Gfx *) pkt;                                                                         \
                                                                                                       \
        _g->words.w0 = _SHIFTL(G_SETSCISSOR, 24, 8) | _SHIFTL((int) ((ulx)), 12, 12)                   \
...
#define gDPScisFillRectangle(pkt, ulx, uly, lrx, lry)                                                  \
    {                                                                                                  \
        Gfx *_g = (Gfx *) (pkt);                                                                       \
                                                                                                       \
        _g->words.w0 = (_SHIFTL(G_FILLRECT, 24, 8) | _SHIFTL(MAX((lrx), 0), 14, 10)                    \
...
#define gDPSetConvert(pkt, k0, k1, k2, k3, k4, k5)                                                     \
    {                                                                                                  \
        Gfx *_g = (Gfx *) (pkt);                                                                       \
                                                                                                       \
        _g->words.w0 = (_SHIFTL(G_SETCONVERT, 24, 8) | _SHIFTL(k0, 13, 9) | _SHIFTL(k1, 4, 9)          \
                        | _SHIFTR(k2, 5, 4));                                                          \
        _g->words.w1 =                                                                                 \
...
#define gsDPSetConvert(k0, k1, k2, k3, k4, k5)                                                         \
    {                                                                                                  \
        {                                                                                              \
            (_SHIFTL(G_SETCONVERT, 24, 8) | _SHIFTL(k0, 13, 9) | _SHIFTL(k1, 4, 9)                     \
             | _SHIFTR(k2, 5, 4)),                                                                     \
                (_SHIFTL(k2, 27, 5) | _SHIFTL(k3, 18, 9) | _SHIFTL(k4, 9, 9) | _SHIFTL(k5, 0, 9))      \
        }                                                                                              \
    }
...
#define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy)                           \
    {                                                                                                  \
        Gfx *_g = (Gfx *) (pkt);                                                                       \
                                                                                                       \
        _g->words.w0 = (_SHIFTL(G_TEXRECT, 24, 8) | _SHIFTL(MAX((s16) (xh), 0), 12, 12)                \
                        | _SHIFTL(MAX((s16) (yh), 0), 0, 12));                                         \
        _g->words.w1 = (_SHIFTL((tile), 24, 3) | _SHIFTL(MAX((s16) (xl), 0), 12, 12)                   \
                        | _SHIFTL(MAX((s16) (yl), 0), 0, 12));                                         \
        gImmp1(pkt, G_RDPHALF_1,                                                                       \
               (_SHIFTL(((s)                                                                           \
                         - (((s16) (xl) < 0)                                                           \
                                ? (((s16) (dsdx) < 0) ? (MAX((((s16) (xl) * (s16) (dsdx)) >> 7), 0))   \
